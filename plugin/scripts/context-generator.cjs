"use strict";var Lt=Object.create;var w=Object.defineProperty;var Dt=Object.getOwnPropertyDescriptor;var yt=Object.getOwnPropertyNames;var vt=Object.getPrototypeOf,Mt=Object.prototype.hasOwnProperty;var Ut=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},ge=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of yt(e))!Mt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Dt(e,n))||s.enumerable});return r};var L=(r,e,t)=>(t=r!=null?Lt(vt(r)):{},ge(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),xt=r=>ge(w({},"__esModule",{value:!0}),r);var ts={};Ut(ts,{generateContext:()=>le});module.exports=xt(ts);var Rt=L(require("path"),1),Nt=require("os"),Ct=require("fs");var Ne=require("bun:sqlite");var f=require("path"),ee=require("os"),P=require("fs");var Se=require("url");var I=require("fs"),v=require("path"),fe=require("os"),Q=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Q||{}),kt=(0,v.join)((0,fe.homedir)(),".claude-mem");function Te(){return process.env.CLAUDE_MEM_DATA_DIR||kt}var Z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;logDataDir=null;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){let e=Te();if(!(this.logFileInitialized&&this.logDataDir===e)){this.logFileInitialized=!0,this.logDataDir=e;try{let t=(0,v.join)(e,"logs");(0,I.existsSync)(t)||(0,I.mkdirSync)(t,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(t,`claude-mem-${s}.log`)}catch(t){console.error("[LOGGER] Failed to initialize log file:",t),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(Te(),"settings.json");if((0,I.existsSync)(e)){let t=(0,I.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Q[n]??1}else this.level=1}catch{this.level=1}return this.level}refreshLevel(){this.level=null}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):m=" "+this.formatData(o));let l="";if(n){let{sessionId:T,memorySessionId:A,correlationId:S,...p}=n;Object.keys(p).length>0&&(l=` {${Object.entries(p).map(([g,b])=>`${g}=${b}`).join(", ")}}`)}let E=`[${i}] [${a}] [${d}] ${u}${s}${l}${m}`;if(this.logFilePath)try{(0,I.appendFileSync)(this.logFilePath,E+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),m=u?`${u[1].split("/").pop()}:${u[2]}`:"unknown",l={...s,location:m};return this.warn(e,`[HAPPY-PATH] ${t}`,l,n),o}},_=new Z;var Pt={};function $t(){return typeof __dirname<"u"?__dirname:(0,f.dirname)((0,Se.fileURLToPath)(Pt.url))}var Ft=$t();function wt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,f.join)((0,ee.homedir)(),".claude-mem"),e=(0,f.join)(r,"settings.json");try{if((0,P.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=wt(),D=process.env.CLAUDE_CONFIG_DIR||(0,f.join)((0,ee.homedir)(),".claude"),is=(0,f.join)(D,"plugins","marketplaces","thedotmack"),as=(0,f.join)(N,"archives"),ds=(0,f.join)(N,"logs"),cs=(0,f.join)(N,"trash"),us=(0,f.join)(N,"backups"),ms=(0,f.join)(N,"modes"),_s=(0,f.join)(N,"settings.json"),be=(0,f.join)(N,"claude-mem.db"),ps=(0,f.join)(N,"vector-db"),ls=(0,f.join)(N,"observer-sessions"),Es=(0,f.join)(D,"settings.json"),gs=(0,f.join)(D,"commands"),Ts=(0,f.join)(D,"CLAUDE.md");function he(r){(0,P.mkdirSync)(r,{recursive:!0})}function Ae(){return(0,f.join)(Ft,"..")}var Oe=require("crypto");var Ht=3e4;function H(r,e,t){return(0,Oe.createHash)("sha256").update([r||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function j(r,e,t){let s=t-Ht;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}function te(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[String(e)]}catch{return[r]}}var h="claude";function jt(r){return r.trim().toLowerCase().replace(/\s+/g,"-")}function y(r){if(!r)return h;let e=jt(r);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:h}function Re(r){let e=["claude","codex","cursor"];return[...r].sort((t,s)=>{let n=e.indexOf(t),o=e.indexOf(s);return n!==-1||o!==-1?n===-1?1:o===-1?-1:n-o:t.localeCompare(s)})}function Xt(r,e){return{customTitle:r,platformSource:e?y(e):void 0}}var X=class{db;constructor(e=be){e!==":memory:"&&he(N),this.db=new Ne.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns()}initializeSchema(){this.db.run(`
    ...
    `).run(t,e)}markSessionCompleted(e){let t=Date.now(),s=new Date(t).toISOString();this.db.prepare(`
      ...
      WHERE id = ?
    `).run(s,t,e)}getStaleActiveSessionIds(e){return this.db.prepare(`
      SELECT id FROM sdk_sessions
      WHERE status = 'active' AND started_at_epoch < ?
    `).all(e).map(s=>s.id)}markSessionsFailed(e){if(e.length===0)return;let t=Date.now(),s=e.map(()=>"?").join(",");this.db.prepare(`
      UPDATE sdk_sessions
      SET status = 'failed', completed_at_epoch = ?
      WHERE id IN (${s})
    `).run(t,...e)}getSessionStartedAtEpoch(e){return this.db.prepare(`
      SELECT started_at_epoch FROM sdk_sessions WHERE id = ? LIMIT 1
    `).get(e)?.started_at_epoch??null}ensureMemorySessionIdRegistered(e,t){let s=this.db.prepare(`
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i,a){let d=i??Date.now(),u=new Date(d).toISOString(),m=H(e,s.title,s.narrative),l=j(this.db,m,d);if(l)return{id:l.id,createdAtEpoch:l.created_at_epoch};let T=this.db.prepare(`
    ...
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a,d){let u=a??Date.now(),m=new Date(u).toISOString();return this.db.transaction(()=>{let E=[],T=this.db.prepare(`
        ...
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         ...
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let S of s){let p=H(e,S.title,S.narrative),R=j(this.db,p,u);if(R){E.push(R.id);continue}let g=T.run(e,t,S.type,S.title,S.subtitle,JSON.stringify(S.facts),S.narrative,JSON.stringify(S.concepts),JSON.stringify(S.files_read),JSON.stringify(S.files_modified),o||null,i,p,m,u,d||null);E.push(Number(g.lastInsertRowid))}let A=null;if(n){let p=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,m,u);A=Number(p.lastInsertRowid)}return{observationIds:E,summaryId:A,createdAtEpoch:u}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,u,m){let l=u??Date.now(),E=new Date(l).toISOString();return this.db.transaction(()=>{let A=[],S=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch,
         generated_by_model)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let g of s){let b=H(e,g.title,g.narrative),Ee=j(this.db,b,l);if(Ee){A.push(Ee.id);continue}let It=S.run(e,t,g.type,g.title,g.subtitle,JSON.stringify(g.facts),g.narrative,JSON.stringify(g.concepts),JSON.stringify(g.files_read),JSON.stringify(g.files_modified),a||null,d,b,E,l,m||null);A.push(Number(It.lastInsertRowid))}let p;if(n){let b=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      ...
      `).run(l,o),{observationIds:A,summaryId:p,createdAtEpoch:l}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o}=t,i=s==="date_asc"?"ASC":"DESC",a=n?`LIMIT ${n}`:"",d=e.map(()=>"?").join(","),u=[...e],m=o?`WHERE id IN (${d}) AND project = ?`:`WHERE id IN (${d})`;return o&&u.push(o),this.db.prepare(`
...
`}function lt(r,e,t,s){let n=[];return s?n.push(...tt(r)):n.push(...je(r)),s?n.push(...st()):n.push(...Xe()),s?n.push(...rt()):n.push(...Ge()),s?n.push(...nt()):n.push(...Be()),q(t)&&(s?n.push(...ot(e,t)):n.push(...We(e,t))),n}var me=L(require("path"),1);function z(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return _.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function _e(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function pe(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function gt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function Et(r,e){return me.default.isAbsolute(r)?me.default.relative(e,r):r}function Tt(r,e,t){let s=z(r);if(s.length>0)return Et(s[0],e);if(t){let n=z(t);if(n.length>0)return Et(n[0],e)}return"General"}function qt(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=gt(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function ft(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?z(r.facts).join(`
`):null}function Vt(r,e,t,s){let n=[];n.push(...Ye(r));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,d=_e(a.displayTime);n.push(...Je(a,d))}else{let a=i.data,d=pe(a.created_at),m=d!==o?d:"";if(o=d,t.has(a.id)){let E=ft(a,s);n.push(...Ke(a,m,E,s))}else n.push(Ve(a,m,s))}return n}function Kt(r,e,t,s,n){let o=[];o.push(...it(r));let i=null,a="";for(let d of e)if(d.type==="summary"){i=null,a="";let u=d.data,m=_e(u.displayTime);o.push(...ut(u,m))}else{let u=d.data,m=Tt(u.files_modified,n,u.files_read),l=pe(u.created_at),E=l!==a;a=l;let T=t.has(u.id);if(m!==i&&(o.push(...at(m)),i=m),T){let A=ft(u,s);o.push(...ct(u,l,E,A,s))}else o.push(dt(u,l,E,s))}return o.push(""),o}function Jt(r,e,t,s,n,o){return o?Kt(r,e,t,s,n):Vt(r,e,t,s)}function St(r,e,t,s,n){let o=[],i=qt(r);for(let[a,d]of i)o.push(...Jt(a,d,e,t,s,n));return o}function bt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ht(r,e){let t=[];return e?(t.push(...F("Investigated",r.investigated,c.blue)),t.push(...F("Learned",r.learned,c.yellow)),t.push(...F("Completed",r.completed,c.green)),t.push(...F("Next Steps",r.next_steps,c.magenta))):(t.push(...$("Investigated",r.investigated)),t.push(...$("Learned",r.learned)),t.push(...$("Completed",r.completed)),t.push(...$("Next Steps",r.next_steps))),t}function At(r,e){return e?mt(r):ze(r)}function Ot(r,e,t){return!q(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?_t(r.totalDiscoveryTokens,r.totalReadTokens):Qe(r.totalDiscoveryTokens,r.totalReadTokens)}var zt=Rt.default.join((0,Nt.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Qt(){try{return new X}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Ct.unlinkSync)(zt)}catch(e){_.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return _.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Zt(r,e){return e?pt(r):Ze(r)}function es(r,e,t,s,n,o,i){let a=[],d=ie(e);a.push(...lt(r,d,s,i));let u=t.slice(0,s.sessionCount),m=we(u,t),l=ue(e,m),E=Pe(e,s.fullObservationCount);a.push(...St(l,E,s,n,i));let T=t[0],A=e[0];bt(s,T,A)&&a.push(...ht(T,i));let S=ce(e,s,o,n);return a.push(...At(S,i)),a.push(...Ot(d,s,i)),a.join(`
`).trimEnd()}async function le(r,e=!1){let t=re(),s=r?.cwd??process.cwd(),n=ye(s),o=n.primary,i=r?.platform_source,a=r?.projects??n.allProjects;r?.full&&(t.totalObservationCount=999999,t.sessionCount=999999);let d=Qt();if(!d)return"";try{let u=a.length>1?$e(d,a,t,i):ae(d,o,t,i),m=a.length>1?Fe(d,a,t,i):de(d,o,t,i);return u.length===0&&m.length===0?Zt(o,e):es(o,u,m,t,s,r?.session_id,e)}finally{d.close()}}0&&(module.exports={generateContext});
