...
let supervisorSingleton: Supervisor | null = null;
...
export function validateWorkerPidFile(options: ValidateWorkerPidOptions = {}): ValidateWorkerPidStatus {
  const pidFilePath = options.pidFilePath ?? getPidFilePath();
