...
import { resetProcessRegistryForTests } from '../../src/supervisor/process-registry.js';
import { resetSupervisorForTests } from '../../src/supervisor/index.js';
...
describe('ProcessRegistry', () => {
  beforeEach(() => {
    testDataDir = path.join(tmpdir(), `claude-mem-process-registry-${process.pid}-${Date.now()}`);
