...
describe('Worker API Endpoints Integration', () => {
  ...
  describeWithLocalhost('Health/Readiness/Version Endpoints', () => {
  ...
  describeWithLocalhost('Error Handling', () => {
  ...
  describeWithLocalhost('Content-Type Handling', () => {
  ...
  describeWithLocalhost('Server State Management', () => {
  ...
  describeWithLocalhost('Server Lifecycle', () => {
