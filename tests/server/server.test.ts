...
const localhostBindingAvailable = await canBindLocalhost();
const describeWithLocalhost = localhostBindingAvailable ? describe : describe.skip;
...
describe('Server', () => {
  ...
  describeWithLocalhost('getHttpServer', () => {
  ...
  describeWithLocalhost('health endpoint', () => {
  ...
  describeWithLocalhost('readiness endpoint', () => {
  ...
  describeWithLocalhost('version endpoint', () => {
  ...
  describeWithLocalhost('404 handling', () => {
